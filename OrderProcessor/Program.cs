...
namespace OrderProcessor
{
    class Program
    {
        static void Main(string[] args)
        {
			...
			string orderfile = System.IO.File.ReadAllText(@"C:\Users\alan.partridge\Desktop\Ordering\medis.txt");
			...
			//a false early match does not occur with the trailing 5 numbers of an item number followed by the first digit of the quantity performs a false match.
		}
	}
}
